...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
 head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio di Daniel Diemoz, UI/UX Designer" },
      { name: "author", content: "Daniel Diemoz" },
      { property: "og:title", content: "Daniel Diemoz — UI/UX Designer" },
      { property: "og:description", content: "Portfolio di Daniel Diemoz, UI/UX Designer" },
