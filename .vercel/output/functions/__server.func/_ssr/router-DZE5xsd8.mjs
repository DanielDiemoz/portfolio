...
const appCss = "/assets/styles-Bl-K_LRq.css";
...
const $$splitComponentImporter = () => import("./index-K0xeBEUA.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      name: "description",
      content: "Portfolio brutalist di un designer UI/UX indipendente. Esperienze digitali che colpiscono duro."
    }, {
      property: "og:title",
      content: "Zome — UI/UX Designer"
    }, {
      property: "og:description",
      content: "Esperienze digitali che colpiscono duro."
    }]
  }),
